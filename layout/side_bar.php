                ...
                <?php if($user_permit<8){ ?>
                    ...
                    <li>
                        <ul class="account nav nav-list collapse">
                            <li><a href="account.php?type=expence" class="l_active"><span class="fa fa-caret-right"></span>Add Expense</a></li>
                    ...
                    <li>
                        <ul class="report nav nav-list collapse">
                            ...
                            <li><a href="report.php?type=expence_report"><span class="fa fa-caret-right"></span>Expense Report</a></li>
